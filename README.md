...
```hcl
module "kms_key" {
  source                  = "git::https://github.com/sohanyadav/terraform-aws-kms.git?ref=v1.0.0"
  name                    = "kms"
  environment             = "test"
...
## Examples
For detailed examples on how to use this module, please refer to the [Examples](https://github.com/sohanyadav/terraform-aws-kms/tree/master/example) directory within this repository.
...
## License
This project is licensed under the **MIT** License - see the [LICENSE](https://github.com/sohanyadav/terraform-aws-kms/blob/master/LICENSE) file for details.
